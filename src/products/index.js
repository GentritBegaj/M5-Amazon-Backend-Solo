...
import { validator } from "../middlewares/productsValidator.js";
import { pipeline } from "stream";
import { getProductsReadStream } from "../lib/fs-tools-review.js";
...
route.get("/exportToCSV", async (req, res, next) => {
  try {
    ...
    const fileStream = getProductsReadStream();
...
route.post("/", validator, async (req, res, next) => {
